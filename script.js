...
function myFunc() {
  ...
  Calendar.prototype.renderEvents = function(events, ele) {
    ...
    events.forEach(function(ev) {
      ...
      var span2 = createElement("span", "description", ev.description);
  ...
  var data = [
		    	{eventName: 'Lunch Meeting 1', description: 'hello my name is rb' ,calendar: 'Home', color: 'blue', date: '2020-06-15'}
		    ];
  for (var a of data) {
    console.log(a);
  }
